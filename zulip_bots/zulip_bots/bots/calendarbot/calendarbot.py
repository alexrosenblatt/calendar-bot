...
class CalendarBotHandler(object):
        ...
        match message_content.split():
            case ['meet',datetime_input,length_minutes]:         
                try:
                    ...
                    self.input_error_reply(message,bot_handler)
    ...
    def input_error_reply(self,message: dict,bot_handler):
    ...
    def parse_meeting_details(self,message,datetime_input,length_minutes=30) -> tuple[int,list,datetime,int,dict]:
        ...
        return sender_id,invitees,meeting_datetime,length_minutes,message
    ...
    def create_calendar_event(self,meeting_details: tuple[int,list,datetime,int,dict],cal):    
        ...
        sender_id,invitees,meeting_datetime,length_minutes,message = meeting_details
        ...
        event.end = meeting_datetime+timedelta(minutes=int(length_minutes))
